...
public class MultiDimGrid3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<MetaFeatureExtractor> extractors = MetaFeatureExtractorsCollection.top3diff();
        ...
        Result<FeaturePoint<BinDataset>> res = new Result<>(0, 0, start);
        
        System.out.println(res.bestValue);
        if(!start.isEmpty()){
            return;
        }

        String path = FolderUtils.openOrCreate("t3", "1");
